...
const ParentEnrollments = () => {
  ...
  // Calculate renewal end date based on package
  const calculateRenewEndDate = (startDate, packageType) => {
  ...
  const handleRenewEnrollment = async () => {
    ...
    if (!renewEndDate) {
      toast.error('Unable to calculate end date')
      return
    }
    ...
    try {
      ...
      toast.success(
        'Renewal created. Proceeding to payment...'
      )
    ...
    <div>
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-dc-muted mt-1">
          View and manage your child's daycare enrollments.
        </p>
      </div>
      ...
      <div className="bg-white/90 backdrop-blur-sm rounded-[2rem] p-6 shadow-[0_20px_50px_-12px_rgba(74,144,164,0.15)] border border-white/60">
        ...
        {reviewMessage && (
          <p className="text-sm text-dc-error-text font-semibold mb-4">
            {reviewMessage}
          </p>
        )}
        ...
        {enrollments.length === 0 ? (
          <div className="text-center py-14">
            ...
            <p className="text-sm text-dc-muted mt-1">
              You haven't enrolled your child in a daycare yet.
            </p>
          </div>
        ) : (
          <>
                ...
                >
                  ...
                  <div className="grid grid-cols-2 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <p className="font-semibold text-dc-blue mt-1">
                        ₹{en.amount || 0}
                      </p>
                    </div>
                      ...
                      <p
                        className={
                          en.paymentStatus === 'paid'
                            ? 'text-dc-green font-semibold text-sm'
                  ...
                  <button
                    ...
                    className={`w-9 h-9 rounded-full text-sm font-semibold transition ${
                      page === pageNumber
                        ...
                        : 'border border-dc-border text-dc-ink hover:bg-dc-hover'
                    }`}
                  >
                    {pageNumber}
                  </button>
          ...
          >
            ...
            <div className="bg-dc-field rounded-2xl p-4 mb-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm text-dc-ink">
                ...
                <p>
                  <strong>Name:</strong>{' '}
                  {selectedEnrollment.child?.name || 'Not available'}
                </p>

                <p>
                  <strong>Gender:</strong>{' '}
                  {selectedEnrollment.child?.gender || 'Not available'}
                </p>
                ...
                <p>
                  ...
                  {selectedEnrollment.ageGroup || 'Not available'}
                </p>
            ...
            <div className="bg-dc-field rounded-2xl p-4 mb-4">
              ...
              <p className="text-sm text-dc-ink">
                <strong>Name:</strong>{' '}
                {selectedEnrollment.daycare?.name || 'Not available'}
              </p>

              <p className="text-sm text-dc-ink mt-2">
                <strong>Address:</strong>{' '}
                {selectedEnrollment.daycare?.address || 'Not available'}
              </p>
            ...
            <div className="bg-dc-field rounded-2xl p-4 mb-4">
              ...
              <div className="grid grid-cols-2 gap-3 text-sm text-dc-ink">
                ...
                <p>
                  ...
                  {selectedEnrollment.package || 'Not available'}
                </p>

                <p>
                  <strong>Amount:</strong>{' '}
                  ₹{selectedEnrollment.amount || 0}
                </p>
                ...
                <p>
                  ...
                  <span
                    className={`px-2 py-1 rounded-full text-xs font-semibold ${statusStyles[selectedEnrollment.enrollmentStatus]}`}
                  >
            ...
            {selectedEnrollment.assignedStaff && (
              <div className="bg-dc-field rounded-2xl p-4 mb-4">
                ...
                <p className="text-sm text-dc-ink">
                  <strong>Name:</strong>{' '}
                  {selectedEnrollment.assignedStaff.name || 'Not available'}
                </p>

                <p className="text-sm text-dc-ink mt-2">
                  <strong>Email:</strong>{' '}
                  {selectedEnrollment.assignedStaff.email || 'Not available'}
                </p>

                <p className="text-sm text-dc-ink mt-2">
                  <strong>Designation:</strong>{' '}
                  {selectedEnrollment.assignedStaff.designation || 'Not available'}
                </p>
            ...
            {(selectedEnrollment.enrollmentStatus === 'expired' ||
              (
                ...
                isEnrollmentExpired(selectedEnrollment.endDate)
              )) && (
                <button
                  type="button"
                  onClick={() =>
                    openRenewalModal(selectedEnrollment)
                  }
              ...
              <div className="mt-3">
                ...
                {reviewingId === selectedEnrollment._id ? (
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex gap-2">
                      ...
                      <button
                        type="button"
                        onClick={() =>
                          handleAddReview(selectedEnrollment)
                        }
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setReviewingId(selectedEnrollment._id)
                    }
          ...
          >
            ...
            <div className="mb-4">
              ...
              <select
                ...
                onChange={(e) => {
                  ...
                  if (renewStartDate && selectedPackage) {
                    ...
                    setRenewEndDate(calculatedEndDate)
                  } else {
                    setRenewEndDate('')
                  }
                }}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-5">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-full px-4 py-3 border-[1.5px] border-dc-border bg-dc-hover text-sm text-dc-ink outline-none"
                />
            ...
            <div className="flex justify-end gap-3">
              ...
              <button
                ...
                className="bg-dc-blue text-white px-5 py-2 rounded-full font-semibold text-sm hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Continue
              </button>
