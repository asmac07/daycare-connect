      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex gap-6">
          ...
          <div className="w-64 bg-white/90 backdrop-blur-sm rounded-[2rem] shadow-[0_20px_50px_-12px_rgba(74,144,164,0.15)] border border-white/60 p-4">
            ...
            <h2 className="font-semibold font-baloo text-dc-ink mb-3 px-1">
              Daycares
            </h2>
            ...
            {daycares.length === 0 ? (
              ...
              <p className="text-sm text-dc-muted px-1">
          ...
          <div className="flex-1">
            ...
            {selectedDaycare ? (
              ...
              <ChatWindow
                ...
                parentId={user.id}
                ownerId={
                  selectedDaycare.owner?._id ||
                  selectedDaycare.owner
                }
                otherUserName={
                  selectedDaycare.owner?.name ||
                  'Daycare Owner'
                }
              />
